    ...
    const response = await preference.create({
      body: {
        ...
        metadata: {
          nombre: nombre || "",
          mensaje: mensaje || "",
          monto_regalo: String(montoRegalo),
          monto_comision_mp: String(montoComisionMP),
          monto_neto_recibido: montoNetoRecibido ? String(montoNetoRecibido) : "",
          monto_full_fee: montoFullFee ? String(montoFullFee) : "",
          monto_my_assume: montoMyAssume ? String(montoMyAssume) : "",
          montoNetoRecibido: montoNetoRecibido ? String(montoNetoRecibido) : "",
          montoFullFee: montoFullFee ? String(montoFullFee) : "",
          montoMyAssume: montoMyAssume ? String(montoMyAssume) : "",
